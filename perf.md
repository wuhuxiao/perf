...
| 方向 | 数据包大小 64 MiB（128 * 128 * 8 * 128 * 4） | 带宽                    | 单个IO的时延     |
|------|---------------------------------------|-----------------------|-------------|
...
| 方向 | 数据包大小 0.5 MiB（1 * 128 * 8 * 128 * 4） | 带宽                    | 单个IO的时延    |
|------|--------------------------------------|-----------------------|---------|
| H2D  | block wise 128次load 1个KV BLOCK       | 38.48 GiB/s | 12.764 μs | 
| D2H  | block wise 128次dump 1个KV BLOCK       | 37.07 GiB/s | 13.252 μs |
![img.png](img.png)
